...
def loop():                       #GUI
    ...
    while True:
        ...
        root.title('BLONWINER')      #Main window title
        ...
        l_logo.place(x=30,y=8)                        #Place the Label in a right position
        ...
        showvalue=1,tickinterval=100,resolution=1,variable=var_pwm,troughcolor='#787D91',fg=color_text,command=set_pwm,bg=color_bg,highlightthickness=0)
        ...
        showvalue=1,tickinterval=1,resolution=1,variable=var_setps,troughcolor='#787D91',fg=color_text,bg=color_bg,highlightthickness=0)
        ...
        showvalue=0.1,tickinterval=0.2,resolution=0.1,variable=var_time,troughcolor='#787D91',fg=color_text,bg=color_bg,highlightthickness=0)
