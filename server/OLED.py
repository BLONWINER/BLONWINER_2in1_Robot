...
# 	draw.text((0, 0), "BLONWINER", fill="white")
# 	draw.text((0, 10), "BLONWINER", fill="white")
# 	draw.text((0, 20), "BLONWINER", fill="white")
# 	draw.text((0, 30), "BLONWINER", fill="white")
# 	draw.text((0, 40), "BLONWINER", fill="white")
# 	draw.text((0, 50), "BLONWINER", fill="white")
# while 1:
# 	time.sleep(1)
...
if __name__ == '__main__':
	screen = OLED_ctrl()
	screen.start()
	screen.screen_show(1, 'BLONWINER')
	while 1:
		time.sleep(10)
		pass
