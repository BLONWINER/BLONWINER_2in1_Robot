...
def  ap_thread():
    os.system("sudo create_ap wlan0 eth0 B2in1Robot 12345678")
...
def run():
    ...
    while True: 
        ...
        if not data:
            ...
            direction_command = 'no'
            move.move(speed_set, direction_command, turn_command)
        elif 'leftForward' == data:
            turn_command = 'leftForward'
            direction_command = 'forward'
            move.move(speed_set, direction_command, turn_command)
        elif 'rightForward' == data:
            turn_command = 'rightForward'
            direction_command = 'forward'
            move.move(speed_set, direction_command, turn_command)
        elif 'leftBackward' == data:
            turn_command = 'leftBackward'
            direction_command = 'backward'
            move.move(speed_set, direction_command, turn_command)
        elif 'rightBackward' == data:
            turn_command = 'rightBackward'
            direction_command = 'backward'
            move.move(speed_set, direction_command, turn_command)
        elif 'TS' in data:
            turn_command = 'no'
