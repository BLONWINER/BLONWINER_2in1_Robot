...
commands_2 = [
    ...
    "sudo pip3 install -r //home/pi/BLONWINER_2in1_Robot/server/requirements.txt",
...
try: #fix conflict with onboard Raspberry Pi audio
    ...
    pass
try:
    os.system("sudo cp -f //home/pi/BLONWINER_2in1Robot/server/config.txt //etc/config.txt")
except:
    os.system("sudo cp -f "+ thisPath  +"/BLONWINER_2in1Robot/server/config.txt //etc/config.txt")
print('The program in Raspberry Pi has been installed, disconnected and restarted. \nYou can now power off the Raspberry Pi to install the camera and driver board (BLONWINER 2 in 1 RPI Board). \nAfter turning on again, the Raspberry Pi will automatically run the program to set the servos port signal to turn the servos to the middle position, which is convenient for mechanical assembly.')
print('restarting...')
