...
def call_Right(event):           #When this function is called,client commands the car to turn right
    global c_r_stu
    if c_r_stu == 0:
        tcpClicSock.send(('rightB').encode())
        c_r_stu=1
...
def call_LeftForward(event):
    tcpClicSock.send(('leftF').encode())
    
def call_RightForward(event):
    tcpClicSock.send(('rightF').encode())
...
def loop():                      #GUI
    ...
    while True:
        ...
        Btn_LeftSide = tk.Button(root, width=8, text='LeftF',fg=color_text,bg=color_btn,relief='ridge')
        Btn_LeftSide.place(x=30,y=210)
        Btn_LeftSide.bind('<ButtonPress-1>', call_LeftForward)
        Btn_LeftSide.bind('<ButtonRelease-1>', call_Turn_stop)

        Btn_RightSide = tk.Button(root, width=8, text='RightF',fg=color_text,bg=color_btn,relief='ridge')
        Btn_RightSide.place(x=170,y=210)
        Btn_RightSide.bind('<ButtonPress-1>', call_RightForward)
        Btn_RightSide.bind('<ButtonRelease-1>', call_Turn_stop)
        
        Btn_LeftSide = tk.Button(root, width=8, text='Out',fg=color_text,bg=color_btn,relief='ridge')
        Btn_LeftSide.place(x=300,y=280)
        Btn_LeftSide.bind('<ButtonPress-1>', call_LeftSide)
        Btn_LeftSide.bind('<ButtonRelease-1>', call_Turn_stop)
    
        Btn_RightSide = tk.Button(root, width=8, text='In',fg=color_text,bg=color_btn,relief='ridge')
        Btn_RightSide.place(x=440,y=280)
